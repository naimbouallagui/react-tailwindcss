...
import "./App.css";
import cat from "./ca.png";
import profile from "./profile.jpg";
import Card from "./components/card/card";
import beachHouse from "./beach-house.jpg";
import beachHouseInterior from "./beach-house-interior.jpg";
import beachHouseView from "./beach-house-view.jpg";

function App() {
  return (
    <>
      <div className="md:container md:mx-auto rounded-xl shadow-md mb-3">
